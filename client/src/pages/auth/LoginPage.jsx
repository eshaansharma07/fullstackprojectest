  ...
  return (
    <div className="mx-auto flex min-h-[80vh] max-w-md items-center px-4 py-12">
      <form onSubmit={handleSubmit} className="glass w-full space-y-5 rounded-[32px] p-8">
        <div>
          <h1 className="font-display text-3xl font-semibold text-white dark:text-white">Welcome back</h1>
          <p className="mt-2 text-sm text-slate-400">Login to access your EventSphere dashboard.</p>
        </div>
